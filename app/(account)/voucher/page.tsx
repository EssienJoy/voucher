						...
						<article className='rounded-2xl bg-white p-5 shadow-sm'>
							...
							<div className='mt-5 grid grid-cols-2 gap-4'>
								<div>
									...
									<p className='mt-1 font-semibold text-text-primary'>10%</p>
								</div>
							...
							<div className='mt-6 flex gap-3 border-t border-gray-100 pt-5'>
								...
								<button className='flex-1 rounded-xl border border-red-100 px-4 py-2.5 text-sm font-semibold text-red-500 transition hover:bg-red-50'>
									Delete
								</button>
							</div>
						</article>
